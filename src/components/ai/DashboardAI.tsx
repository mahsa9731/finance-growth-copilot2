  ...
  if (error) {
    return (
      <div className="min-h-[70vh] bg-blue-50/30 flex items-center justify-center px-6 dir-rtl">
        ...
        <div className="max-w-md w-full bg-white border border-blue-100 rounded-3xl p-7 shadow-[0_15px_50px_rgba(37,99,235,0.08)]">
      ...
      <div className="w-full max-w-[1500px] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16 py-8 lg:py-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-blue-900/70 font-medium mt-2">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
          ...
          <div className="xl:col-span-4 flex flex-col gap-5">
            ...
            <div className="bg-white rounded-3xl p-6 border border-blue-100 shadow-[0_15px_50px_rgba(37,99,235,0.08)] relative overflow-hidden">
              ...
              <div className="relative">
                ...
                {mainInsight ? (
                  <>
                    ...
                    <p className="text-xs text-blue-900/70 font-medium leading-7 mt-3">
                  ...
                  <div className="py-6">
                    ...
                    <p className="text-xs font-medium text-blue-700 mt-2 leading-6">
            ...
            <div className="bg-white rounded-3xl border border-blue-100 shadow-[0_15px_50px_rgba(37,99,235,0.06)] p-5">
